    ...
    return (
        <main className="relative min-h-screen bg-white">
            ...
            <section className="relative h-[85vh] flex items-end overflow-hidden bg-primary">
                ...
                {/* Cinematic Overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/40 to-transparent z-[1]" />
                ...
                <div className="relative z-10 container-wide pb-32">
                    <div className="max-w-4xl space-y-10">
                        <div className="space-y-6">
                            ...
                            >
                                <span className="text-xs font-bold tracking-[0.4em] uppercase text-white/80">The 2024 Collection</span>
                            </motion.div>
                            <motion.h1
                            ...
                            >
                                Signature
                                <br />
                                <span className="italic font-normal opacity-80">Journeys</span>
                            </motion.h1>
                        </div>
                        <motion.p
                            initial={{ opacity: 0 }}
                        ...
                        >
                            &ldquo;Every itinerary is a masterpiece of logistics and luxury, curated to reveal the soul of Africa.&rdquo;
                        </motion.p>
                    </div>
                </div>
                ...
                >
                    <div className="flex items-center gap-6">
                        <span className="text-xs font-bold tracking-[0.4em] uppercase text-white/90 vertical-text">Scroll to explore</span>
                ...
                <div className="container-wide space-y-32 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
                        <div className="max-w-2xl space-y-6">
                            <p className="section-label text-primary">Masterpiece Collection</p>
                        ...
                        <div className="max-w-xs space-y-6">
                            <p className="text-midnight/90 text-xs font-bold tracking-widest uppercase leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {packages.map((pkg, idx) => (
                            <motion.div
                                ...
                                className="group relative flex flex-col bg-white rounded-none overflow-hidden border border-midnight/[0.05] shadow-2xl hover:-translate-y-2 transition-all duration-700"
                            >
                                {/* Image Container */}
                                <div className="relative h-[450px] overflow-hidden">
                                    ...
                                    <div className="absolute top-8 left-8 right-8 flex justify-between items-start">
                                        <span className="px-5 py-2 rounded-none bg-primary text-white text-xs font-bold tracking-widest uppercase">
                                            {pkg.tag}
                                        </span>
                                ...
                                <div className="p-10 flex items-center justify-between border-t border-midnight/5">
                                    <div className="space-y-1">
                                        <p className="text-xs font-bold tracking-[0.3em] uppercase text-midnight/30">Investment from</p>
                                        <p className="text-2xl font-serif text-midnight">{pkg.price}</p>
                                    </div>
                                    <Link
                                        href={`/contact?package=${encodeURIComponent(pkg.title)}`}
                                        className="text-sm font-bold tracking-[0.2em] uppercase text-midnight border-b border-midnight/10 pb-1 hover:border-primary hover:text-primary transition-all duration-300"
                                    >
                                        Inquire Now
                                    </Link>
                                </div>
            ...
            <section className="py-40 bg-white text-center container-wide overflow-hidden relative">
                <div className="max-w-2xl mx-auto space-y-12">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Sparkles className="w-12 h-12 text-primary/20 mx-auto opacity-40" />
                    </motion.div>
                    <h2 className="text-4xl md:text-6xl font-serif italic text-midnight leading-tight">
                        Looking for something <br /> <span className="text-primary font-normal">truly unique?</span>
                    </h2>
                    <p className="text-midnight/80 font-sans tracking-wide leading-relaxed">
                        Our private consultants are specialists in crafting completely <br /> bespoke itineraries tailored to your specific vision.
                    </p>
                    <div className="pt-8">
                        <Link href="/contact" className="group inline-flex items-center gap-6 text-[12px] font-bold tracking-[0.4em] uppercase text-midnight hover:text-primary transition-colors">
